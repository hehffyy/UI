...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui"
  ...
  <xforms:model id="model" style="left:58px;height:auto;top:456px;">
    <xforms:action id="action1" ev:event="xbl-loaded">
      <xforms:script id="xformsScript1"><![CDATA[XzxCardDialog.modelXBLLoaded(event)]]></xforms:script>
    </xforms:action>  
    <xforms:action id="action3" ev:event="onload">
      <xforms:script id="xformsScript3"><![CDATA[XzxCardDialog.modelLoad(event)]]></xforms:script>
    </xforms:action>
  </xforms:model>  
  <xui:view id="rootView" auto-load="true"> 
    ...
    <xui:view auto-load="true" id="view1" class="xui-container"> 
      ...
      <xui:place control="windowDialog1" id="controlPlace7" style="position:absolute;top:59px;left:42px;"></xui:place></layout>  
      <xforms:trigger component="/UI/system/components/trigger.xbl.xml#trigger" id="btnRead"
        ...
        <xforms:action id="action2" ev:event="DOMActivate">
          <xforms:script id="xformsScript2"><![CDATA[XzxCardDialog.btnReadClick(event)]]></xforms:script>
        </xforms:action>
      </xforms:trigger> 
    <xhtml:div component="/UI/system/components/windowDialog.xbl.xml#windowDialog" title="" width="400px" height="300px" modal="true" id="windowDialog1"></xhtml:div></xui:view>  
    <xui:view auto-load="true" id="view4" class="xui-container"> 
      ...
      <xforms:trigger component="/UI/system/components/trigger.xbl.xml#trigger" id="cancelBtn"
        ...
        <xforms:action id="action5" ev:event="DOMActivate">
          <xforms:script id="xformsScript5"><![CDATA[XzxCardDialog.cancelBtnClick(event)]]></xforms:script>
        </xforms:action>
      </xforms:trigger>  
      <xforms:trigger component="/UI/system/components/trigger.xbl.xml#trigger" id="sureBtn"
        ...
        <xforms:action id="action4" ev:event="DOMActivate">
          <xforms:script id="xformsScript4"><![CDATA[XzxCardDialog.sureBtnClick(event)]]></xforms:script>
        </xforms:action>
      </xforms:trigger> 
    </xui:view>  
  ...
  <xui:resource id="resource1"> 
    <xhtml:link rel="stylesheet" type="text/css" id="htmlLink1" href="/UI/base/system/idcard/idcardDialog.css"/>  
    <xhtml:script id="htmlScript2" src="/UI/base/lib/jquery-ui-1.7.1/jquery-1.3.2.js"/>  
    <xhtml:script id="htmlScript1" src="XzxCardDialog.js"/>
  </xui:resource> 
</xui:window>
