...
public class UnSignedTask implements JProcessor {
	public static final String PROCESS = "/SA/task/taskView/taskViewProcess";
	public static final String ACTIVITY = "mainActivity";
	private static final String VIEW = "/UI/SA/task/taskView/unSignedTasksView.xhtml";
	private static final String QUERY_WAIT_TASK_ACTION = "queryUnsignedTaskAction";
