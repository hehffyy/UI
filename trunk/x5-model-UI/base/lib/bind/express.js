	...
	Express.eval = function(exprObj, context, params) {
		...
		if (exprObj instanceof Express) {
			...
			try {
				...
				msg = new Message(Message.JUSTEP230072, exprObj.expr,
						ex.message);
