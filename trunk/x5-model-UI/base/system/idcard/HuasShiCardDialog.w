...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui"
  ...
  <xforms:model id="model" style="left:58px;height:auto;top:456px;"><xforms:action id="action1" ev:event="xbl-loaded"><xforms:script id="xformsScript1"><![CDATA[HuasShiCardDialog.modelXBLLoaded(event)]]></xforms:script></xforms:action>
  <xforms:action id="action3" ev:event="onload"><xforms:script id="xformsScript3"><![CDATA[HuasShiCardDialog.modelLoad(event)]]></xforms:script></xforms:action></xforms:model>  
  <xui:view id="rootView" auto-load="true"> 
    <xui:layout style="margin:0 auto;height:100%;width:660px;" id="rootLayout"> 
      ...
      <xui:place control="sysReceiver" id="controlPlace4" style="position:absolute;left:310px;top:399px;"/> 
    </xui:layout>  
    <xui:view auto-load="true" id="view1" class="xui-container"> 
      <layout type="absolute" style="position:relative;" id="layout1"> 
        ...
        <xhtml:img src="/UI/base/icons/img/person.png" alt="" id="PhotoDisplay"
          style="position:absolute;border-style:dashed dashed dashed dashed;border-width:2px 2px 2px 2px;border-color:#E6EBFF #E6EBFF #E6EBFF #E6EBFF;height:117px;width:104px;left:438px;top:69.5px;"/>  
        ...
        <xui:place control="btnRead" id="controlPlace6" style="position:absolute;width:88px;left:446px;top:5px;"/>  
        ...
        <xhtml:label id="lblDate" class="cardNumValue" style="position:absolute;position:absolute;position:absolute;left:157px;top:196px;"/>  
        <xhtml:input type="radio" value="" name="ckPersonKind" id="ckBr" style="position:absolute;left:74px;top:4px;"
          checked="true"/>  
        <xhtml:input type="radio" value="" name="ckPersonKind" id="ckFr" style="position:absolute;left:155px;top:5px;"/>  
        <xhtml:input type="radio" value="" name="ckPersonKind" id="ckDlr" style="position:absolute;left:233px;top:5px;"/>  
        <xhtml:label id="label5" style="position:absolute;font-family:微软雅黑;font-size:15px;left:105px;top:4px;"
          class="xui-label"><![CDATA[本人]]></xhtml:label>  
        ...
        <xhtml:label id="label11" class="cardLable" style="position:absolute;position:absolute;top:2px;left:22px;"><![CDATA[类  型]]></xhtml:label>
      </layout>  
      ...
      <xforms:action id="action2" ev:event="DOMActivate"><xforms:script id="xformsScript2"><![CDATA[HuasShiCardDialog.btnReadClick(event)]]></xforms:script></xforms:action></xforms:trigger> 
    </xui:view>  
    <xui:view auto-load="true" id="view4" class="xui-container"> 
      <layout type="absolute" style="position:relative;" id="layout4"> 
        <xui:place control="sureBtn" id="controlPlace2" style="float:right;margin-right:10px;position:absolute;width:86px;left:411px;top:11px;"/>  
        <xui:place control="cancelBtn" id="controlPlace3" style="float:right;position:absolute;width:86px;left:509px;top:11px;"/>  
      ...
      <xforms:action id="action5" ev:event="DOMActivate"><xforms:script id="xformsScript5"><![CDATA[HuasShiCardDialog.cancelBtnClick(event)]]></xforms:script></xforms:action></xforms:trigger>  
      <xforms:trigger component="/UI/system/components/trigger.xbl.xml#trigger" id="sureBtn"
        appearance="image-text" class="button-blue"> 
        <xforms:label id="default1">确定</xforms:label> 
      <xforms:action id="action4" ev:event="DOMActivate"><xforms:script id="xformsScript4"><![CDATA[HuasShiCardDialog.sureBtnClick(event)]]></xforms:script></xforms:action></xforms:trigger> 
    </xui:view>  
  ...
  <xui:resource id="resource1"> 
    ...
    <xhtml:script id="htmlScript2" src="/UI/base/lib/jquery-ui-1.7.1/jquery-1.3.2.js"/>
  <xhtml:script id="htmlScript1" src="HuasShiCardDialog.js"></xhtml:script></xui:resource> 
</xui:window>
