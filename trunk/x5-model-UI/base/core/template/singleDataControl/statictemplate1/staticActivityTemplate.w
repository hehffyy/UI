...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui"
        ...
        <center id="borderLayout-center1"> 
          <xhtml:div component="/UI/system/components/splitter.xbl.xml#splitter"
            ...
            <xhtml:div region="right" id="div2"> 
              <xhtml:div component="/UI/system/components/splitter.xbl.xml#splitter" fix-size="180px" mode="horz" id="HSplitter2" class="xui-splitter" fix-type="right" style="height:100%;width:100%;">
   <xhtml:div region="left" id="div3"><xhtml:div id="formView" class="xui-container" style="height:100%;width:100%;"></xhtml:div></xhtml:div>
   <xhtml:div region="right" id="div4"><xhtml:div id="customView" class="xui-container" style="height:100%;width:100%;;"></xhtml:div></xhtml:div></xhtml:div></xhtml:div> 
          </xhtml:div> 
        </center> 
      </xhtml:div>  
  ...
  <xui:resource id="resource"> 
    ...
    <xhtml:script src="/UI/base/core/template/singleDataControl/statictemplate1/staticActivityTemplate.js"/> 
  </xui:resource> 
</xui:window>
