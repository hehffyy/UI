...
selectMultiFunctions.loadTreeData = function() {
	if (!selectMultiFunctions._treeDataLoaded) {
		var r =	justep.Request.sendHttpRequest("/common/commdialogs/funcActivityTree/getFunctionTree.j?type=tree");
...
selectMultiFunctions.loadListData =	function() {
	if (!selectMultiFunctions._listDataLoaded) {
		var r = justep.Request.sendHttpRequest("/common/commdialogs/funcActivityTree/getFunctionTree.j?type=list");
		if (justep.Request.isSuccess(r)) {
