...
$.extend($.jgrid,{
	...
	cellWidth : function () {
		var $testDiv = $("<div class='ui-jqgrid' style='left:0px'><table class='ui-jqgrid-btable'><tr class='jqgrow'><td style='width:5px;'></td></tr></table></div>"),
...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		setPager = function (pgid, tp){
			...
			if(ts.p.pginput===true) {
			$('input.ui-pg-input',"#"+pgcnt)./*keypress*/keydown( function(e) {
