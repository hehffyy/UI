...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui"
  ...
  <xforms:model id="model" style="top:119px;height:auto;left:211px;"> 
    <data concept="B_PrepBizRec" limit="1" auto-load="false" data-type="json"
      store-type="simple" component="/UI/system/components/data.xbl.xml#bizData" id="BizRec"> 
      <reader action="/base/core/flow/logic/action/queryPrepBizRecAction"/>  
      <writer action="/base/core/flow/logic/action/savePrepBizRecAction"/>  
      <creator action="/base/core/flow/logic/action/createPrepBizRecAction"/> 
    </data>  
  ...
  <xui:resource id="resource"> 
    ...
    <xhtml:script src="/UI/base/core/template/prepBizRec/statictemplate/staticActivityTemplate.js"/> 
  </xui:resource> 
</xui:window>
