...
public class AjtjTask extends com.justep.ui.impl.JProcessorImpl {
	public static final String PROCESS = "/base/core/widgets/ajtjTask/ajtjTaskProcess";
	public static final String ACTIVITY = "mainActivity";
	private static final String QUERY_WAIT_TASK_ACTION = "queryAjtjTaskAction";
	...
	private static final String VIEW_JS_TWO = "/x5/UI/base/core/widgets/js/widget.ajtjtask.js";
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.println("</head>");
		pw.println("<body>");
		pw.println("<div id='ajtj-box'></div>");
