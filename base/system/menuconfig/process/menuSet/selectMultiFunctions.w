...
<xui:window xmlns:xui="http://www.justep.com/xui" xmlns="http://www.justep.com/xui"
  ...
  <xforms:model id="model1" style="top:71px;left:206px;"> 
    <data component="/UI/system/components/data.xbl.xml#data" columns="checkBox,label,icon16,icon32,icon64,display,url,process,activity,isFolder,activityFName"
  ...
  <xui:place control="imageSearch" id="controlPlace7" style="height:25px;width:25px;"></xui:place></xhtml:div></top>  
    ...
    <xhtml:div component="/UI/system/components/grid.xbl.xml#grid" show-header-menu="hide-column,save-layout,group-column,adjust-column"
      ...
      <xui:column id="gridColumn13" ref="icon16" label="icon16" type="ro" width="100px"></xui:column><xui:column id="gridColumn14" ref="icon32" label="icon32" type="ro" width="100px"></xui:column><xui:column id="gridColumn15" ref="icon64" label="icon64" type="ro" width="100px"></xui:column><xui:column id="gridColumn16" ref="display" label="display" type="ed" width="100px"></xui:column><xui:column id="gridColumn8" ref="url" label="url" type="ro" width="100px" visible="false"/>  
